...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Initialize Imgur Session for anonymous user
    NSString *imgurClientId = [[ALVNetworkInterface sharedInstance] imgurClientId];
    [IMGSession anonymousSessionWithClientID:imgurClientId withDelegate:self];
